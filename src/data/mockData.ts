...
export const mockCameras: Camera[] = [
  { id: '1', name: 'CAM-01 Entrada Principal', clientId: '1', clientName: 'Condomínio Aurora', streamUrl: 'rtsp://192.168.1.100:554/stream1', protocol: 'RTSP', status: 'online', location: 'Portaria', resolution: '1920x1080', storagePath: 'D:\\Gravacoes\\Aurora\\CAM01', retentionDays: 30, analytics: ['lpr', 'area_intrusion', 'people_counting'] },
  { id: '2', name: 'CAM-02 Estacionamento', clientId: '1', clientName: 'Condomínio Aurora', streamUrl: 'rtsp://192.168.1.101:554/stream1', protocol: 'RTSP', status: 'recording', location: 'Garagem', resolution: '1920x1080', storagePath: 'D:\\Gravacoes\\Aurora\\CAM02', retentionDays: 30, analytics: ['lpr', 'human_car_classification'] },
  { id: '3', name: 'CAM-03 Piscina', clientId: '1', clientName: 'Condomínio Aurora', streamUrl: 'rtmp://192.168.1.102/live/cam3', protocol: 'RTMP', status: 'online', location: 'Área de Lazer', resolution: '1280x720', storagePath: 'D:\\Gravacoes\\Aurora\\CAM03', retentionDays: 15, analytics: ['fallen_person', 'loitering'] },
  { id: '4', name: 'CAM-04 Corredor Loja A', clientId: '2', clientName: 'Shopping Centro', streamUrl: 'rtsp://10.0.1.50:554/stream1', protocol: 'RTSP', status: 'online', location: 'Piso 1', resolution: '1920x1080', storagePath: 'E:\\Gravacoes\\Shopping\\CAM04', retentionDays: 15, analytics: ['people_counting', 'weapon_detection'] },
  { id: '5', name: 'CAM-05 Praça Alimentação', clientId: '2', clientName: 'Shopping Centro', streamUrl: 'rtsp://10.0.1.51:554/stream1', protocol: 'RTSP', status: 'offline', location: 'Piso 2', resolution: '1920x1080', storagePath: 'E:\\Gravacoes\\Shopping\\CAM05', retentionDays: 15, analytics: ['loitering', 'tampering'] },
  { id: '6', name: 'CAM-06 Depósito', clientId: '3', clientName: 'Indústria MetalTech', streamUrl: 'rtmp://172.16.0.10/live/cam6', protocol: 'RTMP', status: 'recording', location: 'Galpão A', resolution: '2560x1440', storagePath: 'D:\\Gravacoes\\MetalTech\\CAM06', retentionDays: 20, analytics: ['area_intrusion', 'weapon_detection', 'tampering'] },
  { id: '7', name: 'CAM-07 Linha de Produção', clientId: '3', clientName: 'Indústria MetalTech', streamUrl: 'rtsp://172.16.0.11:554/stream1', protocol: 'RTSP', status: 'online', location: 'Galpão B', resolution: '1920x1080', storagePath: 'D:\\Gravacoes\\MetalTech\\CAM07', retentionDays: 20, analytics: ['line_crossing', 'fallen_person'] },
  { id: '8', name: 'CAM-08 Pátio Escola', clientId: '4', clientName: 'Escola Futuro', streamUrl: 'rtsp://192.168.2.10:554/stream1', protocol: 'RTSP', status: 'offline', location: 'Pátio', resolution: '1280x720', storagePath: 'D:\\Gravacoes\\Escola\\CAM08', retentionDays: 10, analytics: ['people_counting', 'fallen_person'] },
  { id: '9', name: 'CAM-09 Hall Entrada', clientId: '4', clientName: 'Escola Futuro', streamUrl: 'rtmp://192.168.2.11/live/cam9', protocol: 'RTMP', status: 'offline', location: 'Entrada', resolution: '1920x1080', storagePath: 'D:\\Gravacoes\\Escola\\CAM09', retentionDays: 10, analytics: ['lpr', 'human_car_classification'] },
];
