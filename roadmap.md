...
- [x] Substituir a tela preta por aviso de configuração quando o deploy não receber as variáveis.
- [x] Restaurar a sessão na nuvem ao atualizar a página.
- [x] Corrigir a troca obrigatória de senha no primeiro acesso local.
- [x] Remover os avisos de referência e de navegação na tela de login.
- [x] Manter a análise de IA ativa ao navegar entre telas.
